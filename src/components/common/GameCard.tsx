    ...
    >
      ...
      <View className="flex-row items-start">
        ...
        <View className="flex-1">
          ...
          <View className="flex-row items-center justify-between mb-1">
            <View className="flex-row items-center flex-1">
              <Ionicons
                ...
                size={16}
                color={
                  rarityClasses.accent.includes("text-")
                    ? rarityClasses.accent.replace("text-", "#")
                    : "#00ffff"
                }
                style={{ marginRight: 6 }}
              />
              <Text
                className={`font-orbitron font-medium ${rarityClasses.accent} flex-1`}
                numberOfLines={1}
              >
                {title}
              </Text>
          ...
          {subtitle && (
            <Text
              className="text-white/80 font-inter text-sm mb-1"
              numberOfLines={1}
            >
              {subtitle}
            </Text>
